...
swing1, swing2, swing3, swing4, swing5, swing6, swing7, swing8, swing9, swing10, swing11, swing12, swing13, swing14,

smash1, smash2, smash3, smash4, smash5, smash6, smash7, smash8, smash9, smash10, smash11, smash12, smash13, smash14,
...
bdeath1, bdeath2, bdeath3, bdeath4, bdeath5, bdeath6, bdeath7, bdeath8, bdeath9, bdeath10,
...
ANIM(ogre_swing1,  swing1,  ogre_swing2;  ai_charge(11); sound( self, CHAN_WEAPON, "ogre/ogsawatk.wav", 1, ATTN_NORM );)
...
ANIM(ogre_swing5,  swing5,  ogre_swing6;  ai_charge(9); chainsaw(0); self->s.v.angles[1] += g_random() * 25;)
...
ANIM(ogre_smash1,  smash1,  ogre_smash2;  ai_charge(6); sound( self, CHAN_WEAPON, "ogre/ogsawatk.wav", 1, ATTN_NORM );)
...
void OgreFireGrenade ()
{
	...
	VectorSubtract( PROG_TO_EDICT( self->s.v.enemy )->s.v.origin, self->s.v.origin, missile->s.v.velocity );
