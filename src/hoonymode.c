...
static gedict_t* red_spawns[MAX_CLIENTS] = { 0 };
static gedict_t* blue_spawns[MAX_CLIENTS] = { 0 };
...
void HM_restore_spawns(void)
{
	...
	if (streq(cvar_string("k_hoonymode_prevmap"), strnull(entityFile) ? g_globalvars.mapname : entityFile)) {
