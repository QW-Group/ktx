...
ANIM(dog_walk1, walk1, dog_walk2; if (g_random() < 0.2) sound (self, CHAN_VOICE, "dog/idle.wav", 1, ATTN_IDLE); ai_walk(8);)
...
ANIM(dog_run1,  run1,  dog_run2;  if (g_random() < 0.2) sound (self, CHAN_VOICE, "dog/idle.wav", 1, ATTN_IDLE); ai_run(16);)
