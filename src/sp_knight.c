...
runattack6, runattack7, runattack8, runattack9, runattack10, runattack11,

pain1, pain2, pain3,

painb1, painb2, painb3, painb4, painb5, painb6, painb7, painb8, painb9, painb10, painb11,

//attack1 attack2 attack3 attack4 attack5 attack6 attack7
//attack8 attack9 attack10 attack11

attackb1, attackb2, attackb3, attackb4, attackb5, attackb6, attackb7, attackb8, attackb9, attackb10,
...
deathb1, deathb2, deathb3, deathb4, deathb5, deathb6, deathb7, deathb8, deathb9, deathb10, deathb11,
...
void knight_melee()
{
	...
	VectorAdd( PROG_TO_EDICT(self->s.v.enemy)->s.v.origin, PROG_TO_EDICT(self->s.v.enemy)->s.v.view_ofs, delta );
