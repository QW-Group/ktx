...
qbool frame_is_fast_zombie_pain( int frame )
{
	return (   ( frame >= paina1 && frame <= paina12 )
			...
			|| ( frame >= painc1 && frame <= painc18 )
			|| ( frame >= paind1 && frame <= paind13 )
		   );
}
...
ANIM(zombie_cruc2, cruc_2, zombie_cruc3; self->s.v.nextthink = g_globalvars.time + 0.1 + g_random() * 0.1;)
ANIM(zombie_cruc3, cruc_3, zombie_cruc4; self->s.v.nextthink = g_globalvars.time + 0.1 + g_random() * 0.1;)
ANIM(zombie_cruc4, cruc_4, zombie_cruc5; self->s.v.nextthink = g_globalvars.time + 0.1 + g_random() * 0.1;)
ANIM(zombie_cruc5, cruc_5, zombie_cruc6; self->s.v.nextthink = g_globalvars.time + 0.1 + g_random() * 0.1;)
ANIM(zombie_cruc6, cruc_6, zombie_cruc1; self->s.v.nextthink = g_globalvars.time + 0.1 + g_random() * 0.1;)
...
ANIM(zombie_paina1,  paina1,  zombie_paina2; sound( self, CHAN_VOICE, "zombie/z_pain.wav", 1, ATTN_NORM );)
...
ANIM(zombie_painb1,  painb1,  zombie_painb2; sound( self, CHAN_VOICE, "zombie/z_pain1.wav", 1, ATTN_NORM );)
...
ANIM(zombie_painb9,  painb9,  zombie_painb10; sound( self, CHAN_BODY, "zombie/z_fall.wav", 1, ATTN_NORM );)
...
ANIM(zombie_painc1,  painc1,  zombie_painc2; sound( self, CHAN_VOICE, "zombie/z_pain1.wav", 1, ATTN_NORM );)
...
ANIM(zombie_paind1,  paind1,  zombie_paind2; sound( self, CHAN_VOICE, "zombie/z_pain.wav", 1, ATTN_NORM );)
