...
ANIM(sham_magic1, magic1,
		sham_magic2; ai_face(); sound( self, CHAN_WEAPON, "shambler/sattck1.wav", 1, ATTN_NORM );)
...
ANIM(sham_magic6,
		magic6,
		sham_magic9; CastLightning(); sound( self, CHAN_WEAPON, "shambler/sboom.wav", 1, ATTN_NORM );)
